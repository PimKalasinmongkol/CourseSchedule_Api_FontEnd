...
function Login() {
    ...
    return (
        <div style={{
            ...
            <div className="flex text-red-900 p-5">
            ...
            <diV className="flex justify-center h-screen items-center text-2xl">
                <button className="flex shadow-md p-10 h-1/5  justify-center rounded-2xl bg-white bg-opacity-90 w-3/5 items-center active:bg-red-900 hover:bg-from-color" type="button" onClick={isLogin}>
